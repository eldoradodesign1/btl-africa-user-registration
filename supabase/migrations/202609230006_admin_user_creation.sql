-- BTL Africa: allow admin and super_admin to use the shared user-creation RPC.
-- The shared users schema and RPC signature remain unchanged.
...
begin
  ...
  if creator_role not in ('admin', 'super_admin') then
