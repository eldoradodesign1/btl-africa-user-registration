...
La migration [`supabase/migrations/202609210006_restore_plain_password_confirmation.sql`](supabase/migrations/202609210006_restore_plain_password_confirmation.sql) doit être exécutée après les migrations précédentes. Elle conserve le stockage direct des mots de passe comme dans le fonctionnement historique, tout en exigeant le mot de passe actuel avant toute modification de profil. Elle reste compatible avec d’éventuelles anciennes valeurs bcrypt si la migration de sécurisation précédente a déjà été exécutée par erreur.
