...
Le dashboard se synchronise avec les changements Realtime Supabase sur les tables métier principales et conserve un rafraîchissement de secours toutes les dix secondes lorsque l’application est visible. Une modification effectuée dans Supabase ne dépend donc plus d’un changement d’onglet ou d’un délai de plusieurs minutes.
