...
export function AgentDetailModal({ agent, password, users, campaigns, assignments, campaignSupervisorAssignments, assignmentRequests, canRequest, canExport, canEdit, onEdit, onNotice, onClose }: AgentDetailProps) {
  const assignedIds = new Set([
